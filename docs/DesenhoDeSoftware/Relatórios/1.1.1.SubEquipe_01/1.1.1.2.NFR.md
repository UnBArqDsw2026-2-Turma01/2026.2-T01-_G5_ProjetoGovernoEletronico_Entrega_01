...
| _"Consigo fazer tudo, mesmo sem login?"_ (Passo 7.2 – Acesso parcial / Recusa de consentimento)         | **Parcialmente**. O SIG contempla a restrição em *Responsabilização* (*Bloqueia & audita acesso*), mas o tratamento de degradação da experiência pública não está explicitado sob *Usabilidade*. |
...
### Análise de Cobertura e Rastreabilidade

* **Alinhamento de Trade-offs**: O SIG formaliza o atrito vivenciado pelo usuário ao ler políticas longas por meio da contribuição negativa (`--`) entre *Gestão de Consentimento Explícito* e *Usabilidade*, bem como o impacto geral de *Segurança* sobre *Desempenho* e *Usabilidade*.
* **Oportunidades de Evolução (Próxima Versão)**:
  * **Comunicação de Privacidade**: A dúvida sobre a segurança dos dados compartilhados aponta para a necessidade de um nó operacional como *Termos em Linguagem Simples / Consentimento Gradual* apoiando *Usabilidade* e *Privacidade*.
  * **Navegação Pública**: Detalhar no SIG o suporte a consultas sem autenticação para balancear *Acessibilidade/Usabilidade* sem comprometer *Responsabilização*.
...
| [Artur Galdino](https://github.com/ArturFGaldino) e [Nicole Jovita](https://github.com/nicolejovita) | Tabela de Rastreabilidade com a Rich Picture | 28/08/2026 |
