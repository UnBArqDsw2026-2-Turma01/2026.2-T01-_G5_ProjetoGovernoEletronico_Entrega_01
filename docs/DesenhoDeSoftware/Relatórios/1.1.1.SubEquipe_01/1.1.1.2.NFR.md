...
**Diagramas da versão:**
![SIG na notação do NFR Framework](assets/SIG_ArqSw (1).png)
---
...
**Diagramas da versão:**
![SIG na notação do NFR Framework](assets/nfr-diagram.svg)
[Acessar arquivo goalModel.txt do diagrama NFR](assets/nfr-goalModel.txt)
