...
**O que foi feito:** Adição de balões de pensamento para descrever o que o usuário pensa ao passar pelo fluxo. 
...
| [Artur Galdino](https://github.com/ArturFGaldino) e [Nicole Jovita](https://github.com/nicolejovita) | Criação da Matriz de Impacto com identificação de problemas de privacidade, usabilidade e segurança a partir de pensamentos do usuário | 28/08/2026 |