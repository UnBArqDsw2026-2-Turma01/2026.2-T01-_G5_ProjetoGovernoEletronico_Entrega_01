...
| *"Por que ele quer saber onde eu estou?"* | Etapas 8-9 (solicitação/concessão de acesso à localização) | Falta de transparência sobre o motivo da solicitação de dado sensível (geolocalização); gera desconfiança de privacidade em usuários com baixo letramento digital *(adição: Davi Ursulino de Oliveira, 26/08/2026)* |
